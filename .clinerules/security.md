...
- **sec-no-secrets** [critical]: Never hardcode, print, log, or expose secrets; read secrets only from secure sources (environment variables, secret managers, Key Vaults) and never commit them to version control.
