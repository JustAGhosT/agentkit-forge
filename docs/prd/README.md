...
This folder contains PRDs and related guidance artifacts.

> [!NOTE]
> Some entries are examples and intentionally not factual or comprehensive.
...
- Keep problem statement, goals, and measurable outcomes explicit.
- Include constraints, risks, and open questions.
- Prefer plain-language rationale for model and architecture choices.
