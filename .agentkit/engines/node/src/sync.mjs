...
/**
 * Run an array of async tasks in batches to prevent EMFILE errors.
 * @param {Array} items - Items to process
 * @param {Function} fn - Async function to apply to each item
 * @param {number} concurrency - Max parallel tasks per batch (default: 50)
 */
...
export async function runSync({ agentkitRoot, projectRoot, flags }) {
  ...
  // Compute summary after all files are processed
