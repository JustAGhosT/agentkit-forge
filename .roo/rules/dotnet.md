...
- **dn-xml-docs** [error]: Require XML documentation on all public APIs.
- **dn-async-await** [error]: Mandate async/await patterns; forbid .Result/.Wait() blocking calls.
- **dn-error-handling** [warning]: Enforce proper error handling and structured logging.
- **dn-naming** [warning]: PascalCase for classes/methods/properties, camelCase for parameters/locals.
- **dn-port-naming** [warning]: Port interfaces must be named I{Concept}Port.
- **dn-build-config** [error]: TreatWarningsAsErrors=true; enable CS1591 (XML doc warnings).
